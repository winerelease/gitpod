...
require (
	...
	github.com/gitpod-io/gitpod/refresh-credential v0.0.0-00010101000000-000000000000
...
replace github.com/gitpod-io/gitpod/refresh-credential => ../../components/refresh-credential // leeway
